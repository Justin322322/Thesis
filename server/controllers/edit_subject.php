<?php
// File: C:\xampp\htdocs\AcadMeter\server\controllers\edit_subject.php
...
if ($stmt->execute()) {
    echo json_encode(['status' => 'success', 'message' => 'Subject updated successfully.', 'subject_id' => $subject_id, 'subject_name' => htmlspecialchars($subject_name)]);
} else {
