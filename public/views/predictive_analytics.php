<div id="predictive-analytics" class="content-section">
    <h2 class="mb-4">Predictive Analytics <i class="fas fa-info-circle text-primary" data-toggle="tooltip" title="Identify students likely to fail and take action to improve their outcomes."></i></h2>
